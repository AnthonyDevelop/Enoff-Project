...
import { getAdminRecibirVideosGuardados } from "../../../../../Actions/SuperAdmin/adminRecibirVideos";
...
export default function Guardado(props) {
  ...
  const videosGuardados = props.videosGuardadosObj;
  const imagenPerfilVideo = props.imagenGuardadosObjPerfil;
  ...
  useEffect(() => {
    ...
    if (filtrosActivados === true || videoEliminado == true) {
      dispatch(getAdminRecibirVideosGuardados(dataVideo));
